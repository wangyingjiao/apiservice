...
public class MD5Util {    
     ...
     * @return
     */
    public static String getRequestBodyMD5(String requestBody) {
        String key = null;
//        try {
//            key = AESCrypt.getKey();
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        if(!StringUtils.isNull(requestBody)){
//            str = Base64Encoder.encode(requestBody) + key;
//        }else{
//            str = key;
//        }

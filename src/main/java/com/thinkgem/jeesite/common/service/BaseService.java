...
//
//
//    public static String dataScopeFilter(User user, String tableAlias) {
//
//        String s = dataRoleFilter(user, tableAlias);
//        LoggerFactory.getLogger(BaseService.class).info("数据权限：" + s);
//        return s;
//
//    }
//

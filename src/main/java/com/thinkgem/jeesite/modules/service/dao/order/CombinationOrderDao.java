...
public interface CombinationOrderDao extends CrudDao<CombinationOrderInfo> {
    ...
    //修改已预约次数
    void updateBespeakNumByMasterId(CombinationOrderInfo updateCombinationOrderInfo);
    ...
    void updateStatusCancelByGroupId(CombinationOrderInfo combinationOrderInfo);

    List<OrderInfo> listOrderByGroupId(String group_id);

    void updateStatusSuccessByMasterId(CombinationOrderInfo combinationOrderInfo);

...
public class BasicStoreService extends CrudService<BasicStoreDao, BasicStore> {
    ...
    private List<BasicStore> getTreeStore(List<BasicStore> stores) {
        ...
        List<BasicStore> areaStore = getBasicStores(areaHashStore);
        ...
        List<BasicStore> cityStore = getBasicStores(cityMapStore);
        ...
        List<BasicStore> basicStores = getBasicStores(provMapStore);
        return basicStores;
    ...
    private List<BasicStore> getBasicStores(HashMap<String, List<BasicStore>> areaHashStore) {

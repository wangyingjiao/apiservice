...
public class HttpClientTool {
    ...
    public static String doPost(String url,String md5Content, Map<String, String> params) throws IOException {
        return doPost(url,md5Content, params, CHARSET);
    }
     ...
     * @throws IOException
     */
    public static String doPost(String url,String md5, Map<String, String> params, String charset)
            throws IOException {
        if (StringUtils.isBlank(url)) {
            return null;
        }
        ...
        httpPost.setHeader("md5", md5);
        httpPost.setHeader("appId","selfService");

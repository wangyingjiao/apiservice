...
//        System.err.println(mpg.getCfg().getMap().get("abc"));
    ...
    private static void StrategyConfig(AutoGenerator mpg) {
        ...
        strategy.setTablePrefix(new String[]{"ser_"});// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[]{"ser_city_scope", "ser_item_info", "ser_item_info_goods", "ser_item_info_goods_persons", "ser_skill_goods", "ser_skill_info", "ser_skill_tech", "ser_sort_info"}); // 需要生成的表

...
//        System.err.println(mpg.getCfg().getMap().get("abc"));
    ...
    private static void StrategyConfig(AutoGenerator mpg) {
        ...
        //strategy.setTablePrefix(new String[]{"order_"});// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[]{"order_dispatch" ,"order_goods","order_info","order_pay_info"
        ,"order_refund","order_refund_goods"
        }); // 需要生成的表
